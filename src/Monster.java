...
public class Monster {
    ...
    static final String[] DIRECTIONS = new String[]{"North","East","South","West"};
    ...
    public void moveMonster(Monster[] monster, int arrayItemIndex)
    {
        ...
        while(isSpaceOpen)
        {
            ...
            if(randMoveDistance == 0){
                System.out.println(name + " doesn't move.");
            }else if(randMoveDistance == 1){
                System.out.println(name + " moves " + DIRECTIONS[randMoveDirection] + " " + randMoveDistance + " space.");
            }else{
                System.out.println(name + " moves " + DIRECTIONS[randMoveDirection] + " " + randMoveDistance + " spaces.");
            }
            ...
            if(randMoveDirection == 0)
            {
                ...
                this.yPosition = Math.max((this.yPosition - randMoveDistance), 0);
            } else if (randMoveDirection == 1) {
                this.xPosition = Math.min((this.xPosition + randMoveDistance), maxXBoardSpace);
            } else if (randMoveDirection == 2) {
                this.yPosition = Math.min((this.yPosition + randMoveDistance), maxYBoardSpace);
            } else {
                this.xPosition = Math.max((this.xPosition - randMoveDistance), 0);
            }
    ...
    public boolean onMySpace(Monster[] monster, int indexToChk1, int indexToChk2)
    {
        ...
        return (monster[indexToChk1].xPosition) == (monster[indexToChk2].xPosition) && (monster[indexToChk1].yPosition) == (monster[indexToChk2].yPosition);
    }
